...
*   Project Name : work_queues.c
*
*   Author       : MURUGAN S
*                  murugan.s@fossilshale.com
*   Date         : 29/6/2017
*
*   Description  : A driver that uses workqueue concept.
*
...
#define SUCCESS 0
#define BUF_LEN 80
#define DEVICE_NAME "myworkqueue"
/**********************************************************************
...
*   Function    : work_func_1().
*
*   Description : One of the fuctions which is added to the work queue.
*
*   Parameters  : pointer of type work_struct.
*
*   Return value: none.
...
*   Function    : work_func_2().
*
*   Description : One of the functions which is added to the work queue.
*
*   Parameters  : pointer of type work_struct.
*
*   Return value: none.
